...
class Hash:
    @staticmethod
    def create_hash(data: bytes, salt_type="random") -> str: #data passed in bytes, salt is "random" or "default", or custom string
    ...
    @staticmethod
    def create_client_permanent_key(client_raw_password, client_email) -> bytes:
